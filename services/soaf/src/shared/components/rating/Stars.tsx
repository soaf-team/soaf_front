...
import FullStarIcon from "@assets/icons/stars/fillStar.svg";
import HalfStarIcon from "@assets/icons/stars/halfStar.svg";
import EmptyStarIcon from "@assets/icons/stars/emptyStar.svg";
...
export function StarRating({ size = 16, onChange }: Props) {
